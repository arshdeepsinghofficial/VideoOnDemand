 ...
 * @author hp
 */
public class ViewAllTVShows extends javax.swing.JFrame
{

    ArrayList<Movies> al=new ArrayList<>();
    public ViewAllTVShows(ArrayList<Movies>al)
    {   
        this.setLayout(null);
        initComponents();
        this.setBackground(Color.white);
       // lbMovies.setBackground(Color.red);
    ...
    private void initComponents()
    {
        ...
        lbMovies.setBackground(new java.awt.Color(255, 0, 0));
        lbMovies.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        lbMovies.setText("                                                                          TV Shows");
    ...
    class getAllMovies implements Runnable
    {
      ...
      {   int x=10;
          ...
          gv.setBounds(this.x,this.y,jScrollPane1.getWidth()-40,170);
